  ...
  return (
    <section className="mx-auto flex items-center justify-between py-8 md:py-12 md:pb-8 lg:py-24 lg:pb-20">
      <div className="flex flex-1 flex-col items-start justify-center gap-3">
        ...
        >
          Welcome to our online marketplace, where you can find a wide range of unique items. From vintage collectibles to handmade crafts, we have something for everyone.
        </span>
